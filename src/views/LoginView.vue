                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input v-model="email" type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter email" required>
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-12">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input v-model="password" type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter password" required>
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                        ...
                                        <button type="submit" class="block w-full max-w-xs mx-auto bg-[#06283d] hover:bg-[#06283d] focus:bg-[#B0A3C0] text-white rounded-lg px-3 py-3 font-semibold">Log In</button>
                          
                            
                                </div>
                            </div>
                            <div class="mt-12 text-sm font-display font-semibold text-green text-center">
                                    Don't have an account ?

                                        <!-- <a class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign up</a> -->
                                    <RouterLink to="/signup"><a class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign Up</a></RouterLink>
                                </div>
                        </div>
                    </div>
                </div>
